...
//				 $('#expenseList').listview('refresh');
	    	...
	    	$('#expenseList').append('<li><a href="index.html#expensedialog" data-rel="dialog" data-transition="pop">' + expense.amount + '€    ' + expense.elDescription + '</a></li>');
  ...
  function listperCategory(results, len) {
	     ...
	     for (var i=0; i<len; i++)
	    	...
	    	if (expense.category != wcategory)
			 ...
			 var formattedDate = new Date(dateArray[0], dateArray[1]-1, dateArray[2]);
			 stringformattedDate = formattedDate.format("dddd, d mmmm, yyyy").toString();
	    	 $('#expenseList').append('<li><a href="index.html#expensedialog?id=' + expense.sn + '" data-rel="dialog" data-transition="pop">' + expense.amount + '€    ' + stringformattedDate + ' </a></li>');
			}
  }
